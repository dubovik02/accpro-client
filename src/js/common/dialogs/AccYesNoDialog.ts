 ...
 */
 export default class AccYesNoDialog extends AccDialog {
  ...
  _buttonYes : HTMLButtonElement;
  _buttonNo : HTMLButtonElement;

  constructor(title : string, question : string, onYesEvent : Function, onNoEvent : Function, onErrorEvent : Function) {
