 ...
 */
 export default class ComponentsFactory {
   ...
   */
  createPreloader(loaderText : string) : Element {
  ...
  createSearchForm() : Element {
    ...
    const html = `<input class="input search-section__input-search" tabindex="0" autofocus placeholder="${Properties.lang.dict.search.inputSearchObject}">
   ...
   * @returns HTML формы
   */
   getAdvancedSearchFormHTML() : string {
    return `
