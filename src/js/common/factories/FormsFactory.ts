...
export default class FormsFactory {
  ...
  createSignInForm(formName : string) : Element {
  ...
  createRestoreForm(formName : string) : Element {
  ...
  createNewPasswordForm(formName : string) : Element {
    const form = document.createElement('form');
    form.classList.add('popup__form');
    form.setAttribute('name', formName);
  ...
  createSingleGridForm(formName : string, gridElement : Element) {
  ...
  createInputTextForm(formName : string, labelText : string, inpType : string, inpName : string) : Element {
  ...
  createInputTextAreaForm(formName : string, labelText : string, inpName : string, rows : string) : Element {
  ...
  createPropertiesForm(formName : string, shortDescElName : string, descriptionElName : string, tagsElName : string) : Element {
