 ...
 */
 export default class SandBoxViewFactory {
   ...
   * @returns HTML-строка меню
   */
  getSandBoxMenuHTML() : string {
   ...
   * @returns HTML-строка вкладок
   */
  getSandBoxTabsContainerHTML() : string {
   ...
   * @returns HTML-строка набора вкладок
   */
  getNotebookTabsHTML() : string {
