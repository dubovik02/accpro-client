...
export default class HeaderBuilder extends AccComponent {
   ...
   */
  _buttonLogin : HTMLButtonElement;

  /**
   * Выбор языка
   */
   _buttonLang : HTMLButtonElement;

  //Мменю "Главная"
  _menuItemMain : HTMLElement;

  /**
   * Меню "Новости"
   */
  _menuItemSearch : HTMLElement;

  /**
   * Меню "Песочница"
   */
  _menuItemSandBox : HTMLElement;

  /**
   * Набор пунктов меню
   */
  _menuItemsList : Array<HTMLElement> = [];
   ...
   */
  _createLoginButton(isButLogin : boolean) {
   ...
   */
  _setMenuItemListener(item : HTMLElement , handler : Function) {
   ...
   */
  setActiveMenuItem(activeItem : HTMLElement) {
